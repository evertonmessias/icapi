...
{ ?>
	<div class="settings-icapi">
		<h2 class="title">Configurações do IC-API</h2>
		<hr>
...
{
	add_submenu_page('icapi', 'Settings', 'Settings', 'edit_posts', 'settings', 'icapi_page_html', 1);
}
add_action('admin_menu', 'icapi_options_page');
